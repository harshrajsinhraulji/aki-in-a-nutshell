...
// Basic keyword lists (rudimentary client-side check)
// In production, move this logic to a Cloud Function or Edge Function for better coverage/obscurity
const SELF_HARM_KEYWORDS = ["die", "suicide", "kill myself", "end it all", "hurt myself", "cut myself"];
const PROFANITY_KEYWORDS = ["fuck", "shit", "bitch", "cunt"]; // Example list
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            await addDoc(collection(db, "confessions"), {
                body: text,
                isPublic: !isAnonymous, // If they uncheck anonymous? Usually typical for confessions to be anon.
                // Let's assume the UI toggle is "Post Anonymously" (default true)
            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center bg-dark/95 backdrop-blur-md p-4">
                <div className="bg-dark border border-red-500/50 rounded-2xl max-w-md w-full p-6 text-center shadow-red-500/20 shadow-2xl">
                    ...
                    <p className="text-neutral-300 mb-6">
                        It sounds like you're going through a tough time. We care about you and want you to be safe.
                    </p>
