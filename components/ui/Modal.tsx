                ...
                <>
                    ...
                    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 pointer-events-none">
                        <motion.div
                            ...
                            className="pointer-events-auto w-full max-w-lg rounded-3xl bg-white/90 backdrop-blur-xl p-6 shadow-2xl border border-white/50"
                            role="dialog"
                            aria-modal="true"
                        >
                            {(title || description) && (
                                <div className="mb-4 space-y-1 text-center sm:text-left">
                                    ...
                                    {description && <p className="text-sm text-aki-muted font-body">{description}</p>}
                                </div>
                            )}
