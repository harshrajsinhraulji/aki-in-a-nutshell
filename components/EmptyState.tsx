...
export default function EmptyState({
    ...
    return (
        <section
            className={`glass rounded-2xl sm:rounded-3xl ${classes.container} px-6 sm:px-8`}
            role="status"
            aria-live="polite"
        >
            <div className="flex flex-col items-center justify-center text-center max-w-sm mx-auto">
                {/* Animated emoji icon */}
                <span
                    className={`${classes.icon} mb-4 sm:mb-6 block animate-bounce-soft`}
                    role="img"
                    aria-label={iconAlt}
                ...
                {/* Inviting title */}
                <h2
                    className={`${classes.title} font-semibold mb-2 sm:mb-3`}
                    style={{
                ...
                {isOwner && ownerCTA ? (
                    ...
                    <p
                        className={`${classes.message} lowercase`}
                ...
                {personality && (
                    <p
                        className="text-xs sm:text-sm mt-4 sm:mt-6 font-mono lowercase"
